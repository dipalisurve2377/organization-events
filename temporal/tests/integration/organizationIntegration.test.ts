...
const organizationController = {
  createOrganizationController: async (req, res) => {
  ...
  updateOrganizationController: async (req, res) => {
  ...
  deleteOrganizationController: async (req, res) => {
    const orgId = req.params.id;
  ...
  listOrganizationController: async (req, res) => {
    try {
...
describe('Organization Integration Tests', () => {
  ...
  beforeEach(() => {
    ...
    Object.values(OrganizationMock).forEach((stub) => {
      if (stub.reset) stub.reset();
    });
    Object.values(workflowTriggers).forEach((stub) => {
      if (stub.reset) stub.reset();
    });
