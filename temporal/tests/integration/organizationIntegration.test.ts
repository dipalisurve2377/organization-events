...
const organizationController = {
  ...
  deleteOrganizationController: async (req: Request, res: Response) => {
    ...
    try {
      ...
      res
        .status(500)
        .json({ error: "Failed to start organization deletion workflow" });
    }
  },
...
app.get(
  "/api/organizations",
  organizationController.listOrganizationController
);
...
describe("Organization Integration Tests", () => {
  ...
  describe("POST /api/organizations - Create Organization", () => {
    it("should create organization successfully", async () => {
      ...
      workflowTriggers.triggerCreateOrganization.resolves(
        "create-workflow-123"
      );
    ...
    it("should handle database errors gracefully", async () => {
      ...
      expect(response.body).to.have.property(
        "error",
        "Failed to start organization creation workflow"
      );
    ...
    it("should handle workflow trigger errors gracefully", async () => {
      ...
      workflowTriggers.triggerCreateOrganization.rejects(
        new Error("Temporal workflow failed")
      );
  ...
  describe("PUT /api/organizations/:id - Update Organization", () => {
    it("should update organization successfully", async () => {
      ...
      workflowTriggers.triggerUpdateOrganization.resolves(
        "update-workflow-456"
      );
    ...
    it("should handle database errors during update", async () => {
      ...
      expect(response.body).to.have.property(
        "error",
        "Failed to start organization update workflow"
      );
    });
  });
  ...
  describe("DELETE /api/organizations/:id - Delete Organization", () => {
    it("should delete organization successfully", async () => {
      ...
      workflowTriggers.triggerDeleteOrganization.resolves(
        "delete-workflow-789"
      );
    ...
    it("should handle database errors during deletion", async () => {
      ...
      expect(response.body).to.have.property(
        "error",
        "Failed to start organization deletion workflow"
      );
    });
  });
  ...
  describe("GET /api/organizations - List Organizations", () => {
    ...
    it("should handle workflow errors during listing", async () => {
      // Set up error behavior for this specific test
      workflowTriggers.triggerListOrganizations.rejects(
