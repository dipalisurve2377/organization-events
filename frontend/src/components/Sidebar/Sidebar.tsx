...
const Sidebar: React.FC = () => (
  <aside className="sidebar">
    ...
    <div className="sidebar-logo">
      <img
        src="https://platformatory.io/images/v2/logo/plf-log.svg"
    ...
    <div className="sidebar-nav-item">
      <div className="sidebar-nav-icon">
        <svg width="25" height="25" viewBox="0 0 25 25" fill="none">
          <rect x="2" y="7" width="21" height="15" rx="3" fill="#B1B1B1" />
          <rect x="7" y="2" width="11" height="7" rx="2" fill="#B1B1B1" />
        </svg>
      </div>
      <span className="sidebar-nav-label inactive">Organizations</span>
    </div>
  </aside>
);
